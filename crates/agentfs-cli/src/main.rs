use agentfs_core::{classify_risk, normalize_path, AgentFsError};
use clap::{Parser, Subcommand};
use serde::Serialize;

#[derive(Parser)]
#[command(name = "agentfs-cli")]
#[command(about = "AgentFS native conformance harness")]
struct Cli {
    #[command(subcommand)]
    command: Command,
}
...
fn emit_error(error: AgentFsError) -> ! {
